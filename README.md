...
<head>
  ...
  <title>Organização Solidária — Plataforma Completa</title>
  <style>
    :root{
      --accent-600: #1f7a73;
      --accent-400: #2aa69a;
      ...
      --max-width: 1200px;
      --radius: 10px;
      --shadow: 0 6px 22px rgba(21,32,43,0.08);
    }
    *{box-sizing:border-box;}
    body{
      ...
      line-height:1.5;
      background:linear-gradient(180deg,#f6f8f9,#eef4f3);
      color:#0b1320;
    }
    ...
    .brand{display:flex;align-items:center;gap:0.75rem;font-weight:700;font-size:1.125rem;color:var(--accent-600);}
    .brand .logo{
      width:42px;height:42px;border-radius:8px;
      background:linear-gradient(135deg,var(--accent-600),var(--accent-400));
      display:inline-grid;place-items:center;color:white;font-weight:700;
      box-shadow:0 4px 12px rgba(34,122,116,0.12);
    }
    nav.main-nav ul{list-style:none;margin:0;padding:0;display:flex;gap:0.25rem;}
    nav.main-nav a{display:inline-block;padding:0.55rem 0.75rem;border-radius:8px;color:#062126;font-weight:600;}
    nav.main-nav a:hover, nav.main-nav a:focus{background:rgba(45,140,130,0.08);outline:none;}
    .btn-cta{background:var(--accent-600);color:white;padding:0.5rem 0.9rem;border-radius:8px;font-weight:600;box-shadow:0 6px 18px rgba(31,122,115,0.12);}
    .card{background:var(--card);border-radius:var(--radius);padding:1.1rem;margin-bottom:1rem;box-shadow:var(--shadow);}
    .grid-2{display:grid;grid-template-columns:repeat(2,1fr);gap:1rem;}
    .grid-3{display:grid;grid-template-columns:repeat(3,1fr);gap:1rem;}
    .muted{color:var(--muted);font-size:0.95rem;}
    .projects-list{display:grid;gap:0.9rem;}
    .project{display:flex;gap:1rem;align-items:flex-start;}
    .project img{width:160px;height:100px;object-fit:cover;border-radius:8px;flex-shrink:0;}
    .volunteer-card img{width:100%;height:140px;object-fit:cover;border-radius:8px;}
    .hero{display:grid;grid-template-columns:1fr 420px;gap:2rem;align-items:center;padding:2.2rem 1rem;max-width:var(--max-width);margin:1.2rem auto;}
    .hero img{width:100%;border-radius:8px;box-shadow:var(--shadow);}
    fieldset{margin-bottom:1rem;display:flex;flex-direction:column;}
    fieldset label{margin-bottom:0.3rem;font-weight:600;}
